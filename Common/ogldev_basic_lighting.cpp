...
bool BasicLightingTechnique::Init()
{
    ...
    if (!AddShader(GL_VERTEX_SHADER, "C:\\Users\\ksampathkuma\\cubeshadowdemo\\Common\\Shaders\\basic_lighting.vs")) {
        return false;
    }


    if (!AddShader(GL_FRAGMENT_SHADER, "C:\\Users\\ksampathkuma\\cubeshadowdemo\\Common\\Shaders\\basic_lighting.fs")) {
        return false;
    }
